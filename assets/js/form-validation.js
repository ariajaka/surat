$(document).ready(function() {
    ...
    if ($.isFunction($.fn.validate)) {
        ...
        $('#general_validate').validate({
            ...
            submitHandler: function(form) {
                $.ajax({
                    url: 'sql/pegawai/add.php?member_name='+member_name+'&member_birth_date='+ member_birth_date +'&member_gender=' + member_gender + '&member_business=' + member_business +'&member_email=' + member_email +'&member_phone=' +member_phone+ '&member_address=' + member_address +'&member_facebook_url=' + member_facebook_url + '&member_twitter_url=' +member_twitter_url+'&member_instagram_url=' +member_instagram_url,
                    type: 'GET',
                    dataType: 'json',
                    success: function(s){
                        if(s.status == 'success'){
