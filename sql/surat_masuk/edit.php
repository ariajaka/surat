...
include('../../config/config.php');
	...
	if(isset($_POST['save'])){
		...
		$sql="UPDATE surat_masuk SET id_sm='$id_sm', tgl_catat_sm='$tanggal_catat_sm', nomor_sm='$nomor_surat', alamat_sm='$asal_surat', tgl_sm='$tanggal_sm', perihal='$perihal', sifat_surat='$cmbsifat' WHERE id_sm ='$id'";
