            ...
            <table id="example-1" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo $data_surat_masuk['nomor_sm']; ?></td>
                            ...
                            <td><?php 
                                ...
                                echo substr($tgl_sm, 3,2).' '.$sebut.' '.substr($tgl_sm, 6,4).''; ?></td>
                            <td><?php echo $data_surat_masuk['perihal']; ?></td>
                            <td><?php echo $data_surat_masuk['sifat_surat']; ?></td>
                            <td><?php echo $data_surat_masuk['status']; ?></td>
                            <td>
                                <a href="FORMLEMBAR_DISPOSISI.php?id=<?php echo $data_surat_masuk['id_sm']; ?>" class="btn btn-success btn-sm" target="_blank"><i class="fa fa-print"></i></a>
                                <a href="index.php?mod=surat_masuk&act=edit&id=<?php echo $data_surat_masuk['id_sm']; ?>" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a>
                                <a href="index.php?mod=surat_masuk&act=hapus&id=<?php echo $data_surat_masuk['id_sm']; ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
