...
<section class="box ">
    <header class="panel_header">
        <h2 class="title pull-left">Edit Surat Masuk &nbsp;
            <a href="index.php?mod=surat_masuk" class="btn btn-primary">Lihat Daftar Surat Masuk</a>
        </h2>
                    ...
                    <div class="form-group">
                        <label class="form-label" for="formfield3">Sifat Surat</label>
                          <select name="cmbsifat" id="cmbsifat" class="form-control">
                              <option disabled="disabled" selected="selected"  value="<?php echo $edit['sifat_surat'] ?>"><?php echo $edit['sifat_surat'] ?></option> 
