    ...
    <section class="wrapper main-wrapper" style=''>
        <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
            <div class="page-title">
                <div class="pull-left">
                    <h1 class="title">Surat Keluar <a href="index.php?mod=surat_keluar&act=add" class="btn btn-success"> Tambah Surat Keluar</a></h1>                            
                </div>
            </div>
        </div>
        <div class="clearfix"></div>

        <?php include ('function/surat_keluar-loader.php') ?>
