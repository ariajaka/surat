<?php 
    if (isset($_GET['id'])) {
        $id = $_GET['id'];
        $editsql = "SELECT * FROM pegawai WHERE id_pegawai = $id";
...
<section class="box ">
    <header class="panel_header">
        <h2 class="title pull-left">Edit Pegawai &nbsp;
    ...
    <div class="content-body">    
        <div class="row">
            <form role="form" action="sql/pegawai/edit.php" method="POST">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <!-- ID in Hidden-->
                        <input type="text" name="id" value="<?php echo $edit['id_pegawai'] ?>" hidden>
                    <!-- ID in Hidden -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input type="text" class="form-control" id="formfield2" name="nip" value="<?php echo $edit['nip'] ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input type="text" class="form-control" id="formfield3" name="pangkat" value="<?php echo $edit['pangkat'] ?>" required >
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input type="text" class="form-control" id="formfield4" name="jabatan" value="<?php echo $edit['jabatan'] ?>" required>
                        </div>
                    </div>
                </div>
